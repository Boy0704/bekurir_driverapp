...
import com.bekurir.driverapp.activity.TopupSaldoActivity;
import com.bekurir.driverapp.activity.WalletActivity;
import com.bekurir.driverapp.activity.WithdrawActivity;
...
import com.bekurir.driverapp.item.BanklistItem;
import com.bekurir.driverapp.json.ResponseJson;
import com.bekurir.driverapp.models.BankModels;
...
public class HomeFragment extends Fragment implements OnMapReadyCallback {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (totalMenitNow >= totalpagi && totalMenitNow <= totalsiang && totalMenitNow <= totalsore && totalMenitNow <= totalmalam) {
            ...
            nighttext.setText("Selamat Sore");
        } else {
