...
public class LocService extends Service {
    ...
    public void onCreate() {
        ...
        notification = notificationBuilder.setOngoing(true)
                ...
                .setContentText("Anda bekerja sekarang! aplikasi ini akan menggunakan lokasi di latar belakang untuk mengirim lokasi anda ke server")
    ...
    private class LocationChangeListeningActivityLocationCallback
        ...
        public void onSuccess(LocationEngineResult result) {
            ...
            newlocation = new Location("boyride");
